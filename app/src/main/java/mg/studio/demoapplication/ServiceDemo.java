...
public class ServiceDemo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_26);
    ...
    public void btnSend(View view) {
        ...
        intent.setAction(MyService_26.ACTION_MSG_TO_SERVICE);
        intent.putExtra(MyService_26.KEY_MSG_TO_SERVICE, msgToService);
    ...
    protected void onStart() {
        ...
        intentFilter.addAction(MyService_26.ACTION_UPDATE_CNT);
        intentFilter.addAction(MyService_26.ACTION_UPDATE_MSG);
        intentFilter.addAction(MyService_26.ACTION_UPDATE_USER_SERVICE_DEAD);
    ...
    private void startService() {
        ...
        myIntent = new Intent(this, MyService_26.class);
    ...
    private class MyMainReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(MyService_26.ACTION_UPDATE_CNT)) {
                int int_from_service = intent.getIntExtra(MyService_26.KEY_INT_FROM_SERVICE, 0);
                textViewCntReceived.setText("Service running for \n " + String.valueOf(int_from_service) + "seconds");
            } else if (action.equals(MyService_26.ACTION_UPDATE_MSG)) {
                String string_from_service = intent.getStringExtra(MyService_26.KEY_STRING_FROM_SERVICE);
                textViewMsgReceived.setText(String.valueOf(string_from_service));
            } else if (action.equals(MyService_26.ACTION_UPDATE_USER_SERVICE_DEAD)) {
                String statusService = intent.getStringExtra(MyService_26.KEY_STRING_FROM_SERVICE_INFO);
