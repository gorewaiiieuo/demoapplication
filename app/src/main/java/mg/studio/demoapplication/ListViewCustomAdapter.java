...
public class ListViewCustomAdapter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.listviewcustomadapter);
        ...
        ArrayAdapter arrayAdapter = new ArrayAdapter(this, R.layout.item_layout_20, R.id.item_text, arrayDemo);

        ListView listViewFinal =  findViewById(R.id.listView);
        listViewFinal.setAdapter(arrayAdapter);
        ...
        listViewFinal.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
